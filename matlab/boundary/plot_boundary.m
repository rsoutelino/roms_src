...
% svn $Id: plot_boundary.m 711 2014-01-23 20:36:13Z arango $
%=========================================================================%
...
for n = 1:Nvars,
  ...
  western  = ~cellfun(@isempty, strfind(Bvars(n), '_west' ));
  eastern  = ~cellfun(@isempty, strfind(Bvars(n), '_east' ));
  southern = ~cellfun(@isempty, strfind(Bvars(n), '_south'));
  northern = ~cellfun(@isempty, strfind(Bvars(n), '_south'));
